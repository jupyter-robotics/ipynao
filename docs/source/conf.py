...
# -*- coding: utf-8 -*-
#
# ipynao documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipynao', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipynao.tex', 'ipynao Documentation',
     'Isabel Paredes', 'manual'),
]
